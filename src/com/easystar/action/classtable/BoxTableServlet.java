 ...
 * @author LeonSu
 */
@WebServlet(name = "BoxTableServlet", urlPatterns = "/BoxTable.do")
public class BoxTableServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
        ...
        LogUtil.info(sessionDataImpl, logModuleConsts.DAGL, "创建盒级条目", null, jsonObject.toString());
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            //获取看到的条目权限条件
            String power = contentPower.ContentAuthority(userId, classId, roleId, "BOXID");
        ...
        Tools.sendResponseText(response, jsonObject.toString());
        LogUtil.info(sessionDataImpl, logModuleConsts.DAGL, "读取盒级条目", errMsg, null);
    }
    ...
    protected void doDelete(HttpServletRequest request, HttpServletResponse response) {
        ...
        Tools.sendResponseText(response, jsonObject.toString());
        LogUtil.info(sessionDataImpl, logModuleConsts.DAGL, "删除盒级条目", null, jsonObject.toString());
    }
}
