 ...
 * @author LeonSu
 */
@WebServlet(name = "RoolEnterServlet", urlPatterns = "/SelectRool.do")
public class RoolEnterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!com.easystar.system.utility.Tools.checkSession(request, response)) {
            ...
            EnterClassTable.enter(session, EasyStarConsts.ROOL);
            ret.put("code", 0);
        }

        Tools.sendResponseText(response, ret.toString());
        LogUtil.info(sessionDataImpl, logModuleConsts.DAGL, "进入案卷级管理", null
                , ret.toString());
    }
}
