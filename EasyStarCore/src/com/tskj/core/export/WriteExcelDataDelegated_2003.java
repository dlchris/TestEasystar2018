 ...
 */
public interface WriteExcelDataDelegated_2003 {
     ...
     * @throws Exception
     */
     void writeExcelData(HSSFSheet eachSheet, Integer startRowCount, Integer endRowCount, Integer currentPage, Integer pageSize) throws Exception;
}
