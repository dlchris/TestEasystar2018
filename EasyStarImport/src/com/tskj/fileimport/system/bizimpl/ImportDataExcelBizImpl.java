...
public class ImportDataExcelBizImpl implements ImportDataBiz {
    private String xlsFileName;
    private String xlsFilePath;
    private File xlsFile;

    public ImportDataExcelBizImpl(String xlsFileName, String path) {
    ...
    public ImportDataExcelBizImpl(File xlsFile) {
...
//            }
    ...
    public Map<String, Object> getData(int index) {
        List<String> cols = getColumnValue(row1);
   ...
   /* @Override
    public Map<String, Object> getData(int index) {
        ...
        try {
           ...
           *//* long ltime = System.currentTimeMillis();
            ...
            sheet = wb.getSheetAt(0);
            Row row = sheet.getRow(0);
            List<String> cols = getColumnValue(row);
    ...
    public boolean verfiy(String fieldName) {
        ...
        try {
            ...
            // sheet表
            sheet = wb.getSheetAt(0);
            int colIndex = getIndex(sheet, fieldName);
            int firstRowNum = sheet.getFirstRowNum();
    ...
    public JSONObject verifyDataType(String sourceFieldName, DataTypeConsts fieldType, int fieldSize, String targetFieldName) {
        ...
        try {
            ...
            int colIndex = getIndex(sheet, sourceFieldName);
